...
void main(void)
{
	...
	a=intValidacion();						/*Para valores entero*/ 
	printf("Escriba un numero largo entero:\n");
	b=lintValidacion();						/*Para valores enteros largos*/
	printf("Escriba un numero entero sin signo:\n");
	c=unintValidacion();					/*Para valores entero unicamente positivo*/ 
	printf("Escriba un numero largo entero sin signo:\n");
	d=unlintValidacion();					/*Para valores entero largos unicamente positivo*/ 
	printf("Escriba un numero decimal:\n");
	e=doubleValidacion();					/*Para valores entero con punto decimal*/
	printf("Escriba su nombre:\n");
	SoloCarValidacion(Nombre,0,MAX);		/*Para caracteres*/
